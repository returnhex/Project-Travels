...
<template>
  <section
    class="relative w-full grid place-items-center mx-auto h-[382px] bg-cover bg-center"
    style="background-image: url('/ocean.png')"
  >
    <div class="absolute inset-0 bg-[#0D4E1B] opacity-50" />
    <div
      class="relative z-10 max-w-[952px] flex flex-col items-center gap-6 text-white"
    >
