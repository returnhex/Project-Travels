...
<template>
  ...
  py-6 lg:-py-8 xl:py-12 2xl:py-16 px-4">
    <div
      class="container 
      h-auto 
    ...
    >
      <div
        class="flex flex-col
        gap-2 sm:gap-1 lg:gap-2 xl:gap-3 2xl:gap-6
        justify-center items-center"
      >
        <p
          class="text-[#2E8942] font-semibold text-lg md:text-xl flex mr-5"
        >
      ...
      >
        <motion.div
          ...
          py-3 px-4 lg:p-3 xl:p-4 2xl:p-6 
        ...
        >
          ...
          <div class="flex flex-col items-start gap-1 lg:gap-2 xl:gap-3">
            <h1 class="font-bold text-sm lg:text-lg xl-text-xl 2xl:text-2xl text-[#1A2E46]">
              {{ item.title }}
            </h1>
            <p class="text-[#5B5B5B] text-sm xl:text-lg 2xl:text-xl font-medium text-left">
              {{ item.desc }}
            </p>
          </div>
        </motion.div>
